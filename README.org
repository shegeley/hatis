...
** TODO Get "window manager context" (see definitions) (~app_id~ + ~pid~ & etc) [easy, high priority] [[https://wayland.app/protocols/wlr-foreign-toplevel-management-unstable-v1#zwlr_foreign_toplevel_handle_v1:event:app_id][zwlr_foreign_toplevel_handle_v1:event:app_id]]
